...
export interface IStorage {
  ...
  // Promise operations
  getPromise(id: number): Promise<PromiseType | undefined>;
  getPromisesByPoliticianId(politicianId: number): Promise<PromiseType[]>;
  createPromise(promise: InsertPromise): Promise<PromiseType>;
  updatePromise(id: number, promise: Partial<InsertPromise>): Promise<PromiseType | undefined>;
...
export class MemStorage implements IStorage {
  ...
  private promises: Map<number, PromiseType>;
