...
const Home = () => {
  ...
  return (
    <MainLayout>
      {/* Hero Banner */}
      <div className="bg-primary rounded-xl shadow-lg text-white p-8 mb-8 relative overflow-hidden w-full">
        ...
        <div className="absolute right-0 top-0 h-full  bg-gradient-to-l from-primary-700 to-transparent opacity-60"></div>
      </div>
